...
struct FQosDatacenterInfo
{
	...
	bool                                               bVisible;                                                 // 0x0029(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bBeta;                                                    // 0x002A(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FQosRegionInfo
{
	...
	EQosRegionResult                                   Result;                                                   // 0x0040(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
