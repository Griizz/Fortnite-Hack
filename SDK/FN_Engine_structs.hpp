...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x0034(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.BodyInstance.SleepFamily
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x0070(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x8];                                       // 0x0078(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x13];                                      // 0x00B5(0x0013) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0xF4];                                      // 0x012C(0x00F4) MISSED OFFSET
};
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0078(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.MeshMergingSettings.LODSelectionType
...
struct FTimelineEventEntry
{
	float                                              Time;                                                     // 0x0000(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FScriptDelegate                             EventFunc;                                                // 0x0008(0x000A) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x6];                                       // 0x0004(0x0006) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
};
...
struct FTimelineVectorTrack
{
	...
	struct FScriptDelegate                             InterpFunc;                                               // 0x0008(0x000A) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0008(0x0006) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
struct FTimeline
{
	...
	struct FScriptDelegate                             TimelinePostUpdateFunc;                                   // 0x0058(0x000A) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_RepSkip, CPF_RepNotify, CPF_Interp, CPF_NonTransactional, CPF_EditorOnly, CPF_NoDestructor, CPF_AutoWeak, CPF_ContainsInstancedReference, CPF_AssetRegistrySearchable, CPF_SimpleDisplay, CPF_AdvancedDisplay, CPF_Protected, CPF_BlueprintCallable, CPF_BlueprintAuthorityOnly, CPF_TextExportTransient, CPF_NonPIEDuplicateTransient, CPF_ExposeOnSpawn, CPF_PersistentInstance, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic, CPF_NativeAccessSpecifierProtected, CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0x6];                                       // 0x0058(0x0006) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             TimelineFinishedFunc;                                     // 0x0068(0x000A) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_RepSkip, CPF_RepNotify, CPF_Interp, CPF_NonTransactional, CPF_EditorOnly, CPF_NoDestructor, CPF_AutoWeak, CPF_ContainsInstancedReference, CPF_AssetRegistrySearchable, CPF_SimpleDisplay, CPF_AdvancedDisplay, CPF_Protected, CPF_BlueprintCallable, CPF_BlueprintAuthorityOnly, CPF_TextExportTransient, CPF_NonPIEDuplicateTransient, CPF_ExposeOnSpawn, CPF_PersistentInstance, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic, CPF_NativeAccessSpecifierProtected, CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData04[0x6];                                       // 0x0068(0x0006) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData03[0x20];                                      // 0x0050(0x0020) MISSED OFFSET
};
...
struct FAnimUpdateRateParameters
{
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x0084(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.AnimUpdateRateParameters.ShiftBucket
};
